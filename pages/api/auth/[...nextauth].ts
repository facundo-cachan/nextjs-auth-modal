...
const {
    ...
    options = {
        ...
        providers: [
            ...
            Providers.Facebook({
                clientId: NEXTAUTH_FACEBOOK_ID,
                clientSecret: NEXTAUTH_FACEBOOK_SECRET,
            }),
            Providers.Twitter({
                clientId: NEXTAUTH_TWITTER_ID,
                clientSecret: NEXTAUTH_TWITTER_SECRET,
            }),
            Providers.GitHub({
                clientId: NEXTAUTH_GITHUB_ID,
                clientSecret: NEXTAUTH_GITHUB_SECRET,
            })
            */
        ],

        // @link https://next-auth.js.org/configuration/databases
        database: NEXTAUTH_DATABASE_URL,
        ...
        callbacks: {
             ...
             */
            jwt: async (token: any, user: object, account: object, profile: object, isNewUser: boolean) => {
